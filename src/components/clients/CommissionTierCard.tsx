...
const TIER_DATA: Record<number, { year1: number; year2: number; year3: number }> = {
...
export function CommissionTierCard({ commissionTier }: CommissionTierCardProps) {
    ...
    <div className="glass-card p-6">
      ...
      <div className="space-y-4">
        <p className="text-[#6B5A70]">
          Year {commissionTier} — {tier.year1} bps. Steps to {tier.year2} bps in 8 months
        </p>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          {[
            ...
            <div key={label} className="text-center p-4 bg-[#F3EFF5] rounded-lg">
