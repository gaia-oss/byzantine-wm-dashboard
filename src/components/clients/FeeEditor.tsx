...
import { formatCurrency, calculateAnnualFee } from '@/lib/format';
    ...
    <div className="glass-card p-6">
      ...
      {!editing ? (
        <div className="flex items-center justify-between p-4 bg-[#F8F6FA] rounded-lg border border-[#E8E0EC]">
          ...
          <span className="text-xl font-bold text-[#1A0918]">{currentFee} bps</span>
        </div>
      ) : (
            ...
            <div className="p-4 bg-[#F3EFF5] rounded-lg border border-[#E8E0EC] space-y-2">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-[#1A0918]">{formatCurrency(clientAum)}</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="border-t border-[#E8E0EC] pt-2 flex justify-between">
                  ...
                  <span className="font-bold text-[#702963]">
                    {formatCurrency(calculateAnnualFee(clientAum, Number(newFee)))}
                  </span>
                </div>
              </div>
            </div>
