    ...
    <div className="min-h-screen bg-surface-secondary p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            { label: 'Conversion rate', value: `${conversionRate}%`, sub: 'Invited → Active' },
            { label: 'Avg. time to first deposit', value: '12 days', sub: 'From KYC approval' },
            { label: 'Pipeline status', value: `${totalActive}`, sub: `Active / ${totalInvited} Invited` },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
            ...
            >
              ...
              <div className="text-3xl font-bold text-byzantine mb-1">{stat.value}</div>
