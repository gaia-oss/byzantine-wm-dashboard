...
export default function SettingsPage() {
  ...
  if (fetchedProfile && !profile) {
    ...
    setBankDetails(
      fetchedProfile.bankDetails || { iban: "", bic: "", bankName: "" }
    );
  }

  const handleProfileChange = (
    field: keyof WealthManagerProfile,
    value: string
  ) => {
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                <p className="font-medium text-text-primary mb-1 group-hover:text-byzantine transition-colors">
                  Documentation
                </p>
                <p className="text-xs text-text-muted">
                  View API & partner docs
                </p>
              </button>
              <button
                type="button"
